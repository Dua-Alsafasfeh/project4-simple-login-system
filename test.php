    ...
    <main class="adminmain">
        ...
        ?>
                ...
                <!-- <table class="usertable">
                    ...
                    <tr>
                        <th>E-mail :</th>
                        <td> <?php if (isset($adminemail)) {echo $adminemail;} ?></td>
                    </tr>
                    <tr>
                        <th> Password :</th>
                        <td><?php if (isset($adminpass)) {echo $adminpass;} ?></td>
                    </tr>
                    <tr>
                        <th>Date Created:</th>
                        <td> <?php if (isset($DCreated)) { echo $DCreated;} ?> </td>
                    </tr>
                    <tr>
                        <th>Date last login:</th>
                        <td> <?php if (isset($Dlastlogin)) {echo $Dlastlogin;}?></td>
                    </tr>
                </table>  -->
            </div>
        </div>
